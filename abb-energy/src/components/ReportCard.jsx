...
export default function ReportCard({ data, breakerName, view, from, to }) {
  ...
  useEffect(() => {
    ...
    chartInstance.current = new Chart(ctx, {
      ...
      options: {
        ...
        plugins: {
          legend: { position: "top", labels: { font: { size: 12, weight: "800" }, boxWidth: 12, boxHeight: 12, padding: 16 } },
  ...
  return (
    <div className="report-card visible" id="report-card">
      <div className="rpt-header">
        <div className="rpt-logo">
          <svg width="86" height="28" viewBox="0 0 86 28" xmlns="http://www.w3.org/2000/svg">
            <text x="0" y="20" fontFamily="DM Sans, Arial, sans-serif" fontWeight="500" fontSize="20" fill="#FFFFFF">ABB</text>
          </svg>
        </div>
